...
// Keyword denoting model type
  static final public ModelType ModulesFileType() throws ParseException {
    ...
    case CSG:
      ...
      break;
    case EMDP:
      jj_consume_token(EMDP);
                   modelType=ModelType.EMDP;
      break;
    default:
      jj_la1[12] = jj_gen;
      jj_consume_token(-1);
...
// Action list (0 or more comma-separated identifiers)
  static final public List<String> ActionList() throws ParseException {
        String s;
...
// Player definition
  static final public Player Player() throws ParseException {
        String name = null;
        Player player = null;
        Token begin;
          begin = getToken(1);
    ...
    jj_consume_token(ENDPLAYER);
          player.setPosition(begin, getToken(0)); {if (true) return player;}
    throw new Error("Missing return statement in function");
  }

// Environment definition
  static final public Player Environment() throws ParseException {
        String name = null;
        Player player = null;
        Token begin;
          begin = getToken(1);
    ...
    jj_consume_token(ENDENVIRONMENT);
          player.setPosition(begin, getToken(0)); {if (true) return player;}
    throw new Error("Missing return statement in function");
  }

// Player definition item (module or [action])
  static final public void PlayerItem(Player player) throws ParseException {
        String name = null;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case LBRACKET:
      jj_consume_token(LBRACKET);
...
// Basic expression (top of operator precedence ordering)
  static final public Expression ExpressionBasic(boolean prop, boolean pathprop) throws ParseException {
    ...
    case PGIVENE:
    case EGIVENP:
      ret = ExpressionEnergyReachability(prop, pathprop);
      break;
    case S:
...
// (Property) expression: probabilistic operator P
  ...
  static final public Expression ExpressionEnergyReachability(boolean prop, boolean pathprop) throws ParseException {
    ExpressionEnergyReachability ret = null;
    Token value;
    ExpressionEnergyReachability.EnergyReachabilityType reachabilityType;
    Token begin = null;
    Expression expr = null;
      if (!prop) {if (true) throw generateParseException();}
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case PGIVENE:
      begin = jj_consume_token(PGIVENE);
      value = jj_consume_token(REG_DOUBLE);
                                                   reachabilityType = ExpressionEnergyReachability.EnergyReachabilityType.PROB_GIVEN_ENERGY;
      break;
    case EGIVENP:
      begin = jj_consume_token(EGIVENP);
      value = jj_consume_token(REG_DOUBLE);
                                                   reachabilityType = ExpressionEnergyReachability.EnergyReachabilityType.ENERGY_GIVEN_PROB;
      break;
    default:
      jj_la1[81] = jj_gen;
      jj_consume_token(-1);
    ...
    expr = Expression(false, false);
    jj_consume_token(RBRACKET);
        ret = new ExpressionEnergyReachability(expr, reachabilityType, Double.parseDouble(value.image));
        ret.setPosition(begin, getToken(0));
        {if (true) return ret;}
    throw new Error("Missing return statement in function");
  }
...
// (Property) expression: n-player Nash operator
  static final public Expression ExpressionMultiNash(boolean prop, boolean pathprop) throws ParseException {
...
// (Property) expression: probabilistic operator (n-player Nash)
  static final public ExpressionQuant ExpressionMultiNashProb(boolean prop, boolean pathprop) throws ParseException {
...
// (Property) expression: reward operator (n-player Nash)
  static final public ExpressionQuant ExpressionMultiNashReward(boolean prop, boolean pathprop) throws ParseException {
...
// (Reward) structure index for equilibria
  static final public void MultiNashRewardIndexes(ExpressionMultiNashReward exprMultiNash) throws ParseException {
        Object index = null;
    jj_consume_token(LBRACE);
...
// List of coalitions (player lists) for a strategy (<<>> or [[]]) operator
  static final public List<Coalition> ExpressionStrategyCoalitionList() throws ParseException {
        Coalition coalition;
    ...
    while (true) {
      ...
      coalition = ExpressionStrategyCoalition();
          ...
          {if (true) return coalitions;}
    throw new Error("Missing return statement in function");
  }

// Coalition (player list) for a strategy (<<>> or [[]]) operator
  static final public Coalition ExpressionStrategyCoalition() throws ParseException {
...
// For loop
  ...
  static private boolean jj_3R_184() {
    if (jj_scan_token(EGIVENP)) return true;
    if (jj_scan_token(REG_DOUBLE)) return true;
    return false;
  }

  static private boolean jj_3R_183() {
    if (jj_scan_token(PGIVENE)) return true;
    if (jj_scan_token(REG_DOUBLE)) return true;
    return false;
  }
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0